...
int main() {
    ...
    int add = add_func(num1, num2);
    int min = minus_func(num1, num2);
    int mul = multi_func(num1, num2);
    int sha = share_func(num1, num2);
    int res = rest_func(num1, num2);
    int exp = exponent_win_func(num1, num2);
